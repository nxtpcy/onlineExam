...
public class QueryBase implements Serializable{
	...
	private Map<String, List<? extends Object>> resultMap;
	...
	public Map<String, List<? extends Object>> getResultMap() {
		return resultMap;
	}

	public void setResultMap(Map<String, List<? extends Object>> resultMap) {
